...
class ReaderViewIntegration(
    ...
    private val readerViewButton: BrowserToolbar.ToggleButton = BrowserToolbar.ToggleButton(
        image = ContextCompat.getDrawable(context, mozilla.components.ui.icons.R.drawable.mozac_ic_reader_view_24)!!,
        imageSelected = ContextCompat.getDrawable(context, mozilla.components.ui.icons.R.drawable.mozac_ic_reader_view_24)!!.mutate().apply {
            setTint(ContextCompat.getColor(context, mozilla.components.ui.colors.R.color.photonBlue40))
        },
