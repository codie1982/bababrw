...
import com.grnt.bababrowser001.IntentRequestCodes.REQUEST_CODE_DATA_REPORTING
import com.grnt.bababrowser001.IntentRequestCodes.REQUEST_CODE_SEND_TAB
...
object NotificationManager {
    ...
    private fun getNotificationChannelId(
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val importance = channelImportance ?: NotificationManager.IMPORTANCE_DEFAULT
